    ...
    <div class="p-2">
        ...
        <!-- start: Content -->
         <div class="container mt-5">
            <h5 class="mb-4">Tambah Data Pelajaran</h5>
                              ...
                              <form action="{{ route('pelajaran.store') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    <label for="id_pelajaran" class="form-label">ID Pelajaran</label>
                                     <input type="text" class="form-control @error('id_pelajaran') is-invalid @enderror" id="id_pelajaran" name="id_pelajaran" value="{{ old('id_pelajaran') ? old('id_pelajaran'):$newId  }}" required>
                                    @error('id_pelajaran')
